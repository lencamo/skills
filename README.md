...
| [`signature-svg-generator`](skills/signature-svg-generator/SKILL.md) | When reusable signature-style SVG assets or Vue components should be generated from font files                                      | Converts font-rendered text into SVG paths and optional Vue components with signature animation             |
