...
# Work-Check: Review Before You Ship
...
Run `bash "${CLAUDE_SKILL_DIR:-$HOME/.agents/skills/work-check}/scripts/run-tests.sh"` or the project's known verification command. Paste the full output.
