...
# Work-Think: Design and Validate Before You Build
...
| User said "just do it" before approving the design | Treat it as approval of the last option presented. State which option was selected, then finish the plan. Do not implement inside `/work-think`. |
